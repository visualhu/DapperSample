...
namespace Identity
{
        ...
        where TUser : IdentityMember
    {
        ...
        {
            return _context.ExecuteScalar<string>("Select Name from Member where Id=@MemberId", new { MemberId = memberId });
        }
        ...
        {
            return _context.ExecuteScalar<int>("Select Id from Member where UserName=@UserName", new { UserName = userName });
        }
        ...
        {
            return _context.Query<TUser>("Select * from Member where Id=@MemberId", new { MemberId = memberId })
                .FirstOrDefault();
        }
        ...
        {
            return _context.Query<TUser>("Select * from Member where UserName=@UserName", new { UserName = userName })
                .ToList();
        }
        ...
        {
            return _context.ExecuteScalar<string>("Select PasswordHash from Member where Id = @MemberId", new { MemberId = memberId });
        }
        ...
        {
            return _context.ExecuteScalar<string>("Select SecurityStamp from Member where Id = @MemberId", new { MemberId = memberId });
        }
        ...
        {
            var id = _context.ExecuteScalar<int>(@"Insert into Member
        ...
        {
            _context.Execute(@"Delete from Member where Id = @MemberId", new { MemberId = memberId });
        }
